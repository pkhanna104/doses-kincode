clear; clc;close all;
path_to_data = '/Users/preeyakhanna/Dropbox/Ganguly_Lab/Projects/HP_Sensorized_Object/doses-kincode/data/task_data/patient/';
...
Filename = string(strcat(path_to_data,input,'_jt_angle_un.mat'));
load ([Filename]);
