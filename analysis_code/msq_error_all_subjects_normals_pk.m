...
filename = strcat(path_to_data, 'data/', input, '_jt_angle_un.mat'); 
load ([filename]);
...
for n = 1:10;
  ...
  k = 3;
    for m = 1:12
       ...
       u_unz{n,m} = interp1([1:length(u_n(excel_ut_real(n,1):excel_ut_real(n,2)))],...
                            u_n(excel_ut_real(n,1):excel_ut_real(n,2)),...
                            [1:excel_ut_length]);
       u_start = u_unz{n,m};
